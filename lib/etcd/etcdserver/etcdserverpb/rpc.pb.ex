defmodule Etcdserverpb.AlarmType do
  ...
  @type t :: integer | :NONE | :NOSPACE | :CORRUPT
...
defmodule Etcdserverpb.RangeRequest.SortOrder do
  ...
  @type t :: integer | :NONE | :ASCEND | :DESCEND
...
defmodule Etcdserverpb.RangeRequest.SortTarget do
  ...
  @type t :: integer | :KEY | :VERSION | :CREATE | :MOD | :VALUE
...
defmodule Etcdserverpb.Compare.CompareResult do
  ...
  @type t :: integer | :EQUAL | :GREATER | :LESS | :NOT_EQUAL
...
defmodule Etcdserverpb.Compare.CompareTarget do
  ...
  @type t :: integer | :VERSION | :CREATE | :MOD | :VALUE | :LEASE
...
defmodule Etcdserverpb.AlarmRequest.AlarmAction do
  ...
  @type t :: integer | :GET | :ACTIVATE | :DEACTIVATE
...
defmodule Etcdserverpb.RangeRequest do
  ...
  @type t :: %__MODULE__{
          ...
          limit: integer,
          revision: integer,
          sort_order: Etcdserverpb.RangeRequest.SortOrder.t(),
          sort_target: Etcdserverpb.RangeRequest.SortTarget.t(),
...
defmodule Etcdserverpb.Compare do
  ...
  @type t :: %__MODULE__{
          ...
          result: Etcdserverpb.Compare.CompareResult.t(),
          target: Etcdserverpb.Compare.CompareTarget.t(),
          key: binary,
          range_end: binary
        }
...
defmodule Etcdserverpb.WatchCreateRequest do
  ...
  @type t :: %__MODULE__{
          ...
          filters: [[Etcdserverpb.WatchCreateRequest.FilterType.t()]],
          prev_kv: boolean,
          watch_id: integer,
          fragment: boolean
        }
...
defmodule Etcdserverpb.AlarmRequest do
  ...
  @type t :: %__MODULE__{
          action: Etcdserverpb.AlarmRequest.AlarmAction.t(),
          memberID: non_neg_integer,
          alarm: Etcdserverpb.AlarmType.t()
        }
